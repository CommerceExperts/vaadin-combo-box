...
export const ComboBoxMixin = subclass => class VaadinComboBoxMixinElement extends subclass {
  ...
  _onEnter(e) {
    ...
    if (this.opened && (this.allowCustomValue || this._inputElementValue === '' || this._focusedIndex > -1)) {
      this.__itemClickedOrEnterWhilstFocused = true;
      this.close();
  ...
  _onClosed() {
    ...
    // Fix for https://github.com/vaadin/vaadin-combo-box/issues/819
    if (this.$.overlay._items && this._focusedIndex > -1 && this.__itemClickedOrEnterWhilstFocused) {
     delete this.__itemClickedOrEnterWhilstFocused;
